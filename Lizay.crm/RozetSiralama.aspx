<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="RozetSiralama.aspx.cs" Inherits="Lizay.crm.RozetSiralama" %>
                    ...
                    <div class="panel panel-flat" style="margin-top: 60px; margin-left: 0px; margin-right: 0px; background-color: transparent;">
                        <div class="panel-heading" style="padding-top: 10px; padding-bottom: 10px;">
                            <h5 class="panel-title" style="text-align: center; font-size: 20px; font-weight: bold; color: White">
                                <%=  DateTime.Now.ToString("MMMM", System.Globalization.CultureInfo.CreateSpecificCulture("tr")).ToString() %>
                                <%=  DateTime.Now.ToString("yyyy", System.Globalization.CultureInfo.CreateSpecificCulture("tr")).ToString() %>
                                Rozet Sıralama</h5>
                        </div>
                        <div class="row">
                            <div class="col s12">
                            ...
                            <div id="test1" class="col s12" style="margin-top: 5px; padding-left: 0px; padding-right: 0px;">
                                <h5 class="panel-title" style="text-align: center; font-size: 16px; color: White; margin-bottom: 10px; margin-top: 20px;">En Çok Satan Mağaza (Hedef Bazında)</h5>
                                <ul class="media-list media-list-linked" style="border: 5px solid #92a7bd; margin-right: 10px; margin-left: 10px; padding-top: 20px; -webkit-box-shadow: 0 2px 2px 0 rgba(0,0,0,0.7), 0 1px 5px 0 rgba(0,0,0,0.7), 0 3px 1px -2px rgba(0,0,0,0.7); box-shadow: 0 2px 2px 0 rgba(0,0,0,0.7), 0 1px 5px 0 rgba(0,0,0,0.7), 0 3px 1px -2px rgba(0,0,0,0.7);">
                                    <asp:Repeater ID="listView" runat="server">
                                        <ItemTemplate>
                                            <li class="card" style="margin-bottom: 22px; background-color: white; margin-left: 10px; margin-right: 10px;"><span class="media-link" style="padding: 15px 10px;">
                                                <div class="media-left">
                                                    <%# getrosette(Container.ItemIndex + 1)%>
                                                </div>
                                                <div class="media-body" style="vertical-align: middle">
                                                    <div class="media-heading text-semibold" style="font-size: 16px; float: left; padding-right: 10px; font-family: fantasy;">
                                                        <%# (Container.ItemIndex + 1).ToString()=="3"?Container.ItemIndex + 1+".lük":Container.ItemIndex + 1+".lik"%>
                                                    </div>
                                                    <span class="text-muted" style="font-size: 15px;">
                                                        <%# ((Lizay.dll.entity.MOBILEXPENSELIST)Container.DataItem).SALDEPTX%></span>
                                                </div>
                                ...
                                <h5 class="panel-title" style="text-align: center; font-size: 16px; color: White; margin-bottom: 10px; margin-top: 30px;">En Karlı Satan Mağaza</h5>
                                <ul class="media-list media-list-linked" style="border: 5px solid #92a7bd; margin-right: 10px; margin-left: 10px; padding-top: 20px; -webkit-box-shadow: 0 2px 2px 0 rgba(0,0,0,0.7), 0 1px 5px 0 rgba(0,0,0,0.7), 0 3px 1px -2px rgba(0,0,0,0.7); box-shadow: 0 2px 2px 0 rgba(0,0,0,0.7), 0 1px 5px 0 rgba(0,0,0,0.7), 0 3px 1px -2px rgba(0,0,0,0.7);">
                                ...
                                <h5 class="panel-title" style="text-align: center; font-size: 16px; color: White; margin-bottom: 10px; margin-top: 30px;">En Karlı Pırlanta Satan Mağaza</h5>
                                <ul class="media-list media-list-linked" style="border: 5px solid #92a7bd; margin-right: 10px; margin-left: 10px; padding-top: 20px; -webkit-box-shadow: 0 2px 2px 0 rgba(0,0,0,0.7), 0 1px 5px 0 rgba(0,0,0,0.7), 0 3px 1px -2px rgba(0,0,0,0.7); box-shadow: 0 2px 2px 0 rgba(0,0,0,0.7), 0 1px 5px 0 rgba(0,0,0,0.7), 0 3px 1px -2px rgba(0,0,0,0.7);">
                                    <asp:Repeater ID="listView3" runat="server">
                                        <ItemTemplate>
                                            <li class="card" style="margin-bottom: 22px; background-color: white; margin-left: 10px; margin-right: 10px;"><span class="media-link" style="padding: 15px 10px;">
                                                <div class="media-left">
                                                    <%# getrosette(Container.ItemIndex + 1)%>
                                ...
                                <h5 class="panel-title" style="text-align: center; font-size: 16px; color: White; margin-bottom: 10px; margin-top: 30px;">En Karlı Altın Satan Mağaza</h5>
                                <ul class="media-list media-list-linked" style="border: 5px solid #92a7bd; margin-right: 10px; margin-left: 10px; padding-top: 20px; -webkit-box-shadow: 0 2px 2px 0 rgba(0,0,0,0.7), 0 1px 5px 0 rgba(0,0,0,0.7), 0 3px 1px -2px rgba(0,0,0,0.7); box-shadow: 0 2px 2px 0 rgba(0,0,0,0.7), 0 1px 5px 0 rgba(0,0,0,0.7), 0 3px 1px -2px rgba(0,0,0,0.7);">
                                    <asp:Repeater ID="listView4" runat="server">
                                        <ItemTemplate>
                                            <li class="card" style="margin-bottom: 22px; background-color: white; margin-left: 10px; margin-right: 10px;"><span class="media-link" style="padding: 15px 10px;">
                                                <div class="media-left">
                                                    <%# getrosette(Container.ItemIndex + 1)%>
                            ...
                            <%
                               { %>
                            <div id="test2" class="col s12" style="margin-top: 5px; padding-left: 0px; padding-right: 0px;">
                                <h5 class="panel-title" style="text-align: center; font-size: 16px; color: White; margin-bottom: 10px; margin-top: 20px;">En Çok Satan Personel (Hedef Bazında)</h5>
                                <ul class="media-list media-list-linked" style="border: 5px solid #92a7bd; margin-right: 10px; margin-left: 10px; padding-top: 20px; -webkit-box-shadow: 0 2px 2px 0 rgba(0,0,0,0.7), 0 1px 5px 0 rgba(0,0,0,0.7), 0 3px 1px -2px rgba(0,0,0,0.7); box-shadow: 0 2px 2px 0 rgba(0,0,0,0.7), 0 1px 5px 0 rgba(0,0,0,0.7), 0 3px 1px -2px rgba(0,0,0,0.7);">
                                        ...
                                        <ItemTemplate>
                                            <li class="card" style="margin-bottom: 22px; background-color: white; margin-left: 10px; margin-right: 10px;"><span class="media-link" style="padding: 15px 10px;">
                                                ...
                                                <div class="media-body" style="vertical-align: middle">
                                                    ...
                                                    <span class="text-muted" style="font-size: 15px;">
                                                        <%# ((Lizay.dll.entity.MOBILEXPENSELIST)Container.DataItem).SALDEPTX%></span><br />
                                                    <span class="text-muted" style="font-size: 15px;">
                                                        <%# ((Lizay.dll.entity.MOBILEXPENSELIST)Container.DataItem).MagazaAdi%></span>
                                ...
                                <h5 class="panel-title" style="text-align: center; font-size: 16px; color: White; margin-bottom: 10px; margin-top: 30px;">En Karlı Satan Personel</h5>
                                <ul class="media-list media-list-linked" style="border: 5px solid #92a7bd; margin-right: 10px; margin-left: 10px; padding-top: 20px; -webkit-box-shadow: 0 2px 2px 0 rgba(0,0,0,0.7), 0 1px 5px 0 rgba(0,0,0,0.7), 0 3px 1px -2px rgba(0,0,0,0.7); box-shadow: 0 2px 2px 0 rgba(0,0,0,0.7), 0 1px 5px 0 rgba(0,0,0,0.7), 0 3px 1px -2px rgba(0,0,0,0.7);">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="highlighted-justified-tab1">
                                    <ul class="media-list media-list-linked">
                                        ...
                                        <li class="media"><span class="media-link">
                                            ...
                                            <div class="media-body" style="vertical-align: middle">
                                                <div class="media-heading text-semibold">
                                                    <%# Container.ItemIndex + 1 %>- En Çok Satan Mağaza</div>
                                            </div>
                                            <div class="media-right media-middle text-nowrap">
                                                <span class="text-muted">   <%# ((Lizay.dll.entity.MOBILEXPENSELIST)Container.DataItem).SALDEPTX%> </span>
                                            </div>
                                        </span></li>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                        ...
                                        <li class="media"><span class="media-link">
                                            <div class="media-left">
                                               <%# getrosette(Container.ItemIndex + 1)%></div>
                                            <div class="media-body" style="vertical-align: middle">
                                                <div class="media-heading text-semibold">
                                                    <%# Container.ItemIndex + 1 %>- En Karlı Satan Mağaza</div>
                                            </div>
                                            <div class="media-right media-middle text-nowrap">
                                                <span class="text-muted">   <%# ((Lizay.dll.entity.MOBILEXPENSELIST)Container.DataItem).SALDEPTX%> </span>
                                            </div>
                                        ...
                                        <li class="media"><span class="media-link">
                                            ...
                                            <div class="media-body" style="vertical-align: middle">
                                                <div class="media-heading text-semibold">
                                                    <%# Container.ItemIndex + 1 %>- En Başarılı Pırlanta Satan Mağaza</div>
                                            </div>
                                            <div class="media-right media-middle text-nowrap">
                                                <span class="text-muted">   <%# ((Lizay.dll.entity.MOBILEXPENSELIST)Container.DataItem).SALDEPTX%> </span>
                                            </div>
                                        ...
                                        <li class="media"><span class="media-link">
                                            ...
                                            <div class="media-body" style="vertical-align: middle">
                                                <div class="media-heading text-semibold">
                                                    <%# Container.ItemIndex + 1 %>- En Başarılı Altın Satan Mağaza</div>
                                            </div>
                                            <div class="media-right media-middle text-nowrap">
                                                <span class="text-muted">   <%# ((Lizay.dll.entity.MOBILEXPENSELIST)Container.DataItem).SALDEPTX%> </span>
                                            </div>
                                    ...
                                    <ul class="media-list media-list-linked">
                                      <asp:Repeater ID="Repeater1" runat="server">
                                        ...
                                        <li class="media"><span class="media-link">
                                            ...
                                            <div class="media-body" style="vertical-align: middle">
                                                <div class="media-heading text-semibold">
                                                    <%# Container.ItemIndex + 1 %>- En Çok Satan Personel</div>
                                            </div>
                                            <div class="media-right media-middle text-nowrap">
                                                <span class="text-muted">   <%# ((Lizay.dll.entity.MOBILEXPENSELIST)Container.DataItem).SALDEPTX%> </span>
                                            </div>
                                        ...
                                        <li class="media"><span class="media-link">
                                            ...
                                            <div class="media-body" style="vertical-align: middle">
                                                <div class="media-heading text-semibold">
                                                    <%# Container.ItemIndex + 1 %>- En Karlı Satan Personel</div>
                                            </div>
                                            <div class="media-right media-middle text-nowrap">
                                                <span class="text-muted">   <%# ((Lizay.dll.entity.MOBILEXPENSELIST)Container.DataItem).SALDEPTX%> </span>
                                            </div>
