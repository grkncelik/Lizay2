<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DenetimOdulListesi.aspx.cs" Inherits="Lizay.crm.DenetimOdulListesi" %>
                            ...
                            <tbody>
                                <asp:Repeater ID="listView" runat="server">
                                    <ItemTemplate>
                                        ...
                                        <td></td>
                                            <td>
                                                <%# GetCompanyName(((Lizay.dll.entity.USER_BADGE)Container.DataItem).COMPANY_NO)%>
                                            </td>
                                            <td>
                                                <%# ((Lizay.dll.entity.USER_BADGE)Container.DataItem).CREATED_DATE.ToShortDateString()%>
                                            </td>
                                            <td class="text-center">
                                                <a href="DenetimOdulListesi.aspx?SId=<%# ((Lizay.dll.entity.USER_BADGE)Container.DataItem).ID%>" class="btn btn-danger"><i class=" icon-trash"></i> Kaldır</a>
                                            </td>
                                        <td></td>
                                          <td></td>
                                            <td></td>
