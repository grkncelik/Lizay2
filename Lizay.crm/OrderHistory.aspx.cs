    ...
    public partial class OrderHistory : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ltrImg.Text = Session["ProductImg"].ToString();
                ltrOlcu.Text = Session["Olcu"].ToString();
                ltrOrderDate.Text = Session["OrderDate"].ToString();
                ltrOrderNo.Text = Session["OrderNo"].ToString();
                ltrPrice.Text = Session["ProductPrice"].ToString();
                ltrProductName.Text = Session["ProductName"].ToString();
                ltrText.Text = Session["Text"].ToString();
                ltrProductCode.Text= Session["ProductCode"].ToString();
                ltrOdeme.Text = Session["OdemeTipi"].ToString();
                ltrSiparisNotu.Text = Session["SiparisNotu"].ToString();
