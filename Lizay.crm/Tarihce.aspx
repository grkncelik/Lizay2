<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tarihce.aspx.cs" Inherits="Lizay.crm.Tarihce" %>
                ...
                <div class="content-container animated fadeInUp">
                    <div class="page-block margin-bottom">
                        <div class="content-article">
                            <h1 class="entry-title page">Tarihçe</h1>
                          
                            <div class="entry-content">
                                <p>
                                    1978
                                     <br />
                                    Mahmut Serbes sektöre ilk olarak 1978 yılında aile şirketinde adım attı.
                                </p>
                                <p>
                                    1994
                                     <br />
                                    Adapazarı’nda ilk mağazasını kendi adıyla açtı.
                                </p>
                                <p>
                                    1999
                                     <br />
                                    Adapazarı depreminin ardından mağazasını enkaz altından özveriyle çıkararak ‘enkazdan çıkan pırlanta’nın öyküsünü oluşturdu.
                                </p>

                                <p>
                                    2007
                                     <br />
                                    Viaport alışveriş merkezindeki ilk Lizay mağazası, markalaşma  yolundaki ilk adım oldu.
                                </p>
                                <p>
                                    2011
                                     <br />
                                    Perakendenin yanı sıra altın toptan ve “Diamond stone” markasıyla pırlanta toptan satışına giriş yapıldı.
                                </p>

                                <p>
                                    2012
                                     <br />
                                    Sakarya’da bulunan Lizay Genel Merkezi, kuyumculuğun kalbi Nuruosmaniye’ye taşındı. Türkiye’nin birçok bölgesine ürünler toptan ağı kurularak gönderilmeye başlandı.
                                </p>
                                <p>
                                    2013
                                     <br />
                                    Pırlantada uluslararası geçerliliği olan “HRD Sertifikası” kullanılmaya başlandı.
                                </p>
                                <p>
                                    2014
                                     <br />
                                    Adapazarı ve İstanbul dışına çıkılarak Kocaeli, Gebze ve Çorlu ile birlikte mağaza sayısı 11’e ulaştı.
                                </p>

                                <p>
                                    2015
                                     <br />
                                    Lizay Yönetim Kurulu Üyesi Yeliz Serbes şirket bünyesine katılarak geliştirdiği proje ve çalışmalarını faaliyete geçirdi.
                                </p>

                                <p>
                                    2016
                                     <br />
                                    Daha çok müşteriye ulaşabilmek amacıyla franchise sistemine giriş yapıldı.
                                </p>

                                <p>
                                    2017
                                     <br />
                                    Franchise sistemi kapsamında mağaza sayısını ikiye katlayarak Türkiye kuyumculuk sektörünün önde gelen isimlerinden biri oldu.
                                </p>
                                ...
                                <br />
                                    ...
                                    Lizay Yönetim Kurulu Üyesi Çağatay Serbes, Miami Üniversitesi’nde aldığı  lisans eğitiminin ardından Türkiye’ye dönerek  Lizay bünyesinde çalışmalarına başladı.
     <br />
                                    Sevilen dizilerden Ufak Tefek Cinayetler’in sponsorluğu ile birlikte marka bilinirliliği daha da arttı. 
                                </p>
