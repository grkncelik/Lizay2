<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Degerlerimiz.aspx.cs" Inherits="Lizay.crm.Degerlerimiz" %>
            ...
            <div id="page">
                ...
                <div class="content-container animated fadeInUp">
                    ...
                    <div class="content-article">
                        <h1 class="entry-title page">Değerlerimiz</h1>
            
                        <div class="entry-content">
                            <p>
                                <b>Vizyon</b>
                                <br />
                                Geleneksel çizgideki ürün gruplarına modern yorumlar getirerek kuyumculuk sektörünün önde gelen isimlerinden olmaktır.
                            </p>
                            <p>
                                <b>Misyon</b>
                                <br />
                                Tasarım ve hizmet kalitemizle müşterilerimizin yaşamına her anlamda değer katmak.
                            </p>
                            <p>
                                <b>Değerlerimiz</b>
                                <br />
                                Tasarım ve teknoloji alanında Dünya’daki gelişmeleri yakından takip ederek, ilklere imza atmak
                             <br />
                                <br />
                                İnovasyonu esas alıp; tasarım, üretim, pazarlama, yönetime hizmet anlayışını “yenilikçilik” temelinde yapılandırmak,
                             <br />
                                <br />
                                Mağazalar ve bayiler kanalıyla; müşterilerinin istek ve beklentilerini yakından izleyip, geri bildirimlerini bu anlayış doğrultusunda yönlendirmek,
                             <br />
                                <br />
                                Lizay markasını satış noktalarında, alışveriş merkezlerinde ve popüler caddeler üzerinde konumlandırarak geniş tüketici kitlelerine ulaştırmak,
                             <br />
                                <br />
                                Yurtiçinde ve yurtdışında sağlam iş ortaklıkları kurarak paydaşlarıyla birlikte büyümek,
                             <br />
                                <br />
                                Modern pazarlama kanalları ve yöntemlerini kullanarak Dünya çapında Lizay marka bilinirliliğini yükseltecek yatırımlara süreklilik kazandırmak,
                             <br />
                                <br />
                                5 yıl ve üzeri dönemleri kapsayan, ekonomik ve sosyokültürel gelişmeler doğrultusunda sürekli güncellenen kurumsal planlama ile gelişimi yönetmek
                        <br />
                                <br />
                            </p>
