<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="DuyuruListesi.aspx.cs" Inherits="Lizay.crm.DuyuruListesi" %>
                            ...
                            <tbody>
                                <asp:Repeater ID="listView" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                               <%-- <a href="<%# ((Lizay.dll.entity.ANNOUNCEMENT)Container.DataItem).IMG%>" data-popup="lightbox">
                                                    <img src="<%# ((Lizay.dll.entity.ANNOUNCEMENT)Container.DataItem).IMG%>" alt="" class="img-rounded img-preview">
                                                </a>--%>
                                                 <img src="<%# ((Lizay.dll.entity.ANNOUNCEMENT)Container.DataItem).IMG%>" alt="" class="img-rounded img-preview">
                                            </td>
                                            <td>
                                                <%# ((Lizay.dll.entity.ANNOUNCEMENT)Container.DataItem).TITLE%>
                                            </td>
                                         
                                             <td>
                                             <a href=" <%# ((Lizay.dll.entity.ANNOUNCEMENT)Container.DataItem).DOCFILE%>">Dokümanı İndir</a>
                                            </td>
                                               <td >
                                            <p style=" white-space:normal">
                                                <%# ((Lizay.dll.entity.ANNOUNCEMENT)Container.DataItem).DESCRIPTION.ToString().Length>150?((Lizay.dll.entity.ANNOUNCEMENT)Container.DataItem).DESCRIPTION.ToString().Substring(0,150)+"...":((Lizay.dll.entity.ANNOUNCEMENT)Container.DataItem).DESCRIPTION.ToString()%>
                                            </p></td>
                                            <td>
                                                <%# ((Lizay.dll.entity.ANNOUNCEMENT)Container.DataItem).PUB_DATE%>
                                            </td>
                                            <td>
                                                <%# ((Lizay.dll.entity.ANNOUNCEMENT)Container.DataItem).TYPE%>
                                            </td>
                                            <td class="text-center">
                                                <a href="DuyuruListesi.aspx?SId=<%# ((Lizay.dll.entity.ANNOUNCEMENT)Container.DataItem).ANNOUNCE_ID%>" class="btn btn-danger"><i class=" icon-trash"></i> Kaldır</a>
                                            </td>
