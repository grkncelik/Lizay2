<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UrunEkle.aspx.cs" Inherits="Lizay.crm.UrunEkle" %>
                    ...
                    <div class="card-content" style="padding: 20px;">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label>
                                        Kategori Seçiniz</label>
                                    <asp:DropDownList ID="dropKategori" CssClass="form-control" runat="server">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-md-6">
                                    <label>
                                ...
                                <div class="col-md-6">
                                    <label>
                                        Ürün Açıklama</label>
                                    <textarea rows="5" cols="5" class="form-control" placeholder="" id="txtDetail" runat="server"></textarea>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label>
                                        İndirimli Fiyatı</label>
                                    <input type="text" class="form-control" runat="server" id="txtDiscount" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label>
                                        Ürün Url</label>
                                    <input type="text" class="form-control" runat="server" id="txtUrl" />
                                </div>
                                <div class="col-md-6">
                                    <label class="display-block">
                                        Ürün Görseli Yükle</label>
