<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GarantiSartlari.aspx.cs" Inherits="Lizay.crm.GarantiSartlari" %>
            ...
            <div id="page">
                ...
                <div class="content-container animated fadeInUp">
                    ...
                    <div class="content-article">
                        <h1 class="entry-title page">Garanti Şartları</h1>
                     
                        <div class="entry-content">
                            <p>
                                Lizaypirlanta.com web sitesindeki tüm ürünler Lizay Pırlanta garantisi altında, özel sertifikalarıyla birlikte satışa sunulmaktadır. Tamir ve/veya bakım olacak ürününüzü  Garanti Sertifikası ile birlikte yaptırabilirsiniz. Bununla birlikte satın aldığınız ürünleri uzun yıllar kullanabilmeniz için gerekli olan desteği sağlamak için Lizay Pırlanta her zaman yanınızdadır.

                            </p>
                            <p>
                                Lizaypirlanta.com’dan satın alınan ürünlerin garantilerinin devam edebilmesi için Lizay Pırlanta dışındaki üçüncü şahıs ve kurumların ürünlere herhangi bir şekilde müdahalede bulunmamaları, boyut ayarlama, onarma vb. işlemler yapmamaları gerekmektedir. Üzerinde değişiklik ya da tahrifat yapılan ürünler saklama koşullarından dolayı deforme olmuş; yanlış kullanım sonucu ezilmiş ve darbe görmüş, herhangi bir tür kimyasal maddeyle temas etmesinden dolayı bozulmuş ürünler garanti kapsamı dışında tutulacaktır.
                            </p>
                            <p>
                                Ürünlerin tamiri sırasında gerçekleşecek tüm kargo ücretleri müşteri tarafından karşılanmaktadır.
                            </p>
