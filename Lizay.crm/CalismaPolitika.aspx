<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalismaPolitika.aspx.cs" Inherits="Lizay.crm.CalismaPolitika" %>
        ...
        <div id="main">
            ...
            <div id="page">
                ...
                <div class="content-container animated fadeInUp">
                    ...
                    <h1 class="entry-title page">Çalışma Politikamız</h1>
               
                    <div class="entry-content">
                        <p>
                     Üretim ve tedarik aşamasından müşteri sunumuna kadar olan süreçte kalite anlayışını benimsemek,<br /><br />

Müşterinin talep ve ihtiyaçlarına uygun ürün ve erişebilir fiyat politikası güderek proaktif anlayışla çalışmak,<br /><br />

Satış ve sonrası verdiğimiz hizmetle kalıcı iş birlikteliği yakalamak,<br /><br />

Karşılıklı fayda içeren iş ortaklıkları kurmak,<br /><br />

Marka değerlerine sahip çıkarak kalite anlayışından taviz vermemek,<br /><br />

Marka ruhu ve bilincini paydaşlarımızla birlikte yaşamak,<br /><br />

Marka bilinirliğini ve sürekliliğini sağlamak,<br /><br />

Kurumsal çalışma ilkelerine bağlı kalmak,<br /><br />
                        </p>
