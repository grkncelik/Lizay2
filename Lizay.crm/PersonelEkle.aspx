<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="PersonelEkle.aspx.cs" Inherits="Lizay.crm.PersonelEkle" %>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label>
                                        Gsm Numarası</label>
                                    <input type="text" class="form-control" runat="server" id="txtGsm" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <asp:DropDownList ID="dropUserType" CssClass="form-control" runat="server">
                                        <asp:ListItem Text="Seçiniz" Value=""></asp:ListItem>
                                        <asp:ListItem Text="Admin" Value="ADMIN"></asp:ListItem>
                                        <asp:ListItem Text="Müdür" Value="MUDUR"></asp:ListItem>
                                        <asp:ListItem Text="Personel" Value="PERSONEL"></asp:ListItem>
                                        <asp:ListItem Text="Franchise Kullanıcısı" Value="FRANCHISE"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group">
